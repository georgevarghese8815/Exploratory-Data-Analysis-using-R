...
ggplot(aes(x = carat, y = price), data = diamonds) +
  geom_point(fill = I('#F79420'), color = I('black'), shape = 21) + xlim(0, quantile(diamonds$weight, 0.99)) +
...
ggplot(aes(x = carat, y = price), data = diamonds) +
  ...
  scale_x_continuous(lim = c(0, quantile(diamonds$weight, 0.99))) +
  scale_y_continuous(lim = c(0, quantile(diamonds$price, 0.99))) + geom_smooth()
...
load('C:/Users/George varghese/Desktop/BigDiamonds.Rda')
head(diamondsbig)
...
predict(m5, newdata = thisDiamond, interval = 'prediction', level = .95)
exp(modelEstimate)
```
